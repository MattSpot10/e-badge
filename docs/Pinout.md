...
| IO4      | 8               | I/O/T |  Y     | B LED       | RTC_GPIO4, GPIO4,TOUCH4,ADC1_CH3                                                   |
| IO5      | 9               | I/O/T |  Y     | G LED       | RTC_GPIO5, GPIO5,TOUCH5,ADC1_CH4                                                   |
| IO6      | 10              | I/O/T |  Y     | R LED       | RTC_GPIO6, GPIO6,TOUCH6,ADC1_CH5                                                   |
...
| IO10     | 14              | I/O/T |  X     | SPI2 MISO   | RTC_GPIO10, GPIO10,TOUCH10,ADC1_CH9,FSPICS0,FSPIIO4, SUBSPICS0                     |
...
| IO19     | 23              | I/O/T |  X     | USB-        | RTC_GPIO19,GPIO19,U1RTS,ADC2_CH8,CLK_OUT2, USB_D-                                  |
| IO20     | 24              | I/O/T |  X     | USB+        | RTC_GPIO20,GPIO20,U1CTS,ADC2_CH9,CLK_OUT1, USB_D+                                  |
| IO21     | 25              | I/O/T |  X     | I2C SCL     | RTC_GPIO21, GPIO21                                                                 |
| IO26^{b} | 26              | I/O/T |  X     | SPI FLASH   | SPICS1, GPIO26                                                                     |
| IO47     | 27              | I/O/T |  X     | I2C SDA     | SPICLK_P_DIFF, GPIO47,SUBSPICLK_P_DIFF                                             |
| IO33     | 28              | I/O/T |  X     | SPI FLASH   | SPIIO4, GPIO33,FSPIHD,SUBSPIHD                                                     |
| IO34     | 29              | I/O/T |  X     | SPI FLASH   | SPIIO5, GPIO34,FSPICS0,SUBSPICS0                                                   |
| IO48     | 30              | I/O/T |  X     | Display RST | SPICLK_N_DIFF, GPIO48,SUBSPICLK_N_DIFF                                             |
| IO35     | 31              | I/O/T |  X     | SPI FLASH   | SPIIO6, GPIO35,FSPID,SUBSPID                                                       |
| IO36     | 32              | I/O/T |  X     | SPI FLASH   | SPIIO7, GPIO36,FSPICLK,SUBSPICLK                                                   |
| IO37     | 33              | I/O/T |  X     | SPI FLASH   | SPIDQS, GPIO37,FSPIQ,SUBSPIQ                                                       |
| IO38     | 34              | I/O/T |  Y     | A           | GPIO38,FSPIWP,SUBSPIWP                                                             |
| IO39     | 35              | I/O/T |  X     | JTAG        | MTCK,GPIO39,CLK_OUT3,SUBSPICS1                                                     |
| IO40     | 36              | I/O/T |  X     | JTAG        | MTDO,GPIO40,CLK_OUT2                                                               |
| IO41     | 37              | I/O/T |  X     | JTAG; C LED | MTDI,GPIO41,CLK_OUT1                                                               |
| IO42     | 38              | I/O/T |  X     | JTAG; Buzzer| MTMS,GPIO42                                                                        |
| TXD0     | 39              | I/O/T |  X     | UART        | U0TXD,GPIO43,CLK_OUT1                                                              |
| RXD0     | 40              | I/O/T |  X     | UART        | U0RXD,GPIO44,CLK_OUT2                                                              |
| IO45     | 41              | I/O/T |  X     | Strapping   | GPIO45                                                                             |
| IO46     | 44              | I/O/T |  X     | Strapping   | GPIO46                                                                             |
